...
sourceImgFolderName='Test Pattern Images';
MyFolderInfo = dir(sourceImgFolderName);
noOfFileinAFolder=size(MyFolderInfo);

for fileNo=3:noOfFileinAFolder
sourceImgName=MyFolderInfo(fileNo).name;
[filepath,name,ext] = fileparts(sourceImgName); 
...
Name={'Output Metadata Table Version';'Source Image File Name';'Source Image File Path';...
    ...
    'Weighted Zoned Image Entropy Table File Name';'Run Metadata Output Table File Name'};
Name1={'Source Image Entropy';'Grayscale Averaging Image Entropy';'Zonned Mapped Image Entropy';...
        'Weighted Zonned Mapped Image Entropy';'Total Pixels in trim image'};
...
OutputMetaData=table(Index,Name,Type,Data);
OutputMetaData1=table(Index1,Name1,Entropy);
